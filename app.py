...
st.markdown("""
    ...
    .project-badge {
        ...
        border: 1px solid rgba(255, 255, 255, 0.9); color: #1e40af;
        font-weight: 700; font-size: 0.95rem; padding: 0.35rem 1.2rem;
        border-radius: 9999px; letter-spacing: 0.8px;
    }
    ...
    .stTextInput input {
        background-color: #ffffff !important; border-radius: 9999px !important;
        font-size: 1.05rem !important; padding: 1rem 1.8rem !important; text-align: center !important;
        box-shadow: 0 10px 25px rgba(0, 0, 0, 0.06) !important;
    }

    .stButton button[kind="primary"] {
        background: #2563eb !important; color: white !important;
        border-radius: 9999px !important; padding: 0.75rem 2.5rem !important; font-weight: 700 !important;
    ...
    /* Refined Custom Styling for Horizontal Tabs */
    ...
    /* Metric Label & Value Readability */
    ...
    /* =========================================================
       1. PRIMARY BUTTON: Dark Slate Navy (Classify Clinical Note)
       ========================================================= */
    ...
    /* =========================================================
       2. SECONDARY BUTTON: Peach/Pink Gradient (View Model Analysis)
       ========================================================= */
    button[data-testid="baseButton-secondary"] {
        background: linear-gradient(135deg, #FFDAB9 0%, #FFB6C1 100%) !important;
    ...
    button[data-testid="baseButton-secondary"]:hover {
        background: linear-gradient(135deg, #FFD1A9 0%, #FFA6B1 100%) !important;
        border-color: rgba(255, 255, 255, 0.8) !important;
        box-shadow: 0 6px 16px rgba(255, 182, 193, 0.45) !important;
        transform: translateY(-1px);
    }
    </style>
...
if st.session_state.current_page == "classifier":
    ...
    with col_nav2:
        st.button("📈 View Model Analysis & EDA Insights →", on_click=go_to_page, args=("analysis",), use_container_width=True)
